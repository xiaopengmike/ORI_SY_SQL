...
def list_page():
    ...
    try:
        ...
        return render_template('customer/templates/customer/list.html',
...
def add():
    ...
    return render_template('customer/templates/customer/add.html',
...
def detail_query():
    ...
    return render_template('customer/templates/customer/detail.html',
                         main=main,
                         contacts=contacts,
                         company=company,
                         share=share,
...
def modify(form_id):
    ...
    return render_template('customer/templates/customer/modify.html',
                         main=main,
                         contacts=contacts,
                         company=company,
                         continent_arr=continent_arr,
...
def change(form_id):
    ...
    return render_template('customer/templates/customer/change.html',
                         main=main,
                         contacts=contacts,
                         company=company,
                         continent_arr=continent_arr,
...
def demo_sidebar():
    ...
    展示新的左侧导航栏功能
    """
    return render_template('common/templates/demo_sidebar.html')
