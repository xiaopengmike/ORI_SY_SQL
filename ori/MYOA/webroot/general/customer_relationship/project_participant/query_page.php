...
$totalQuery = "select k.*,o.approve_user,o.step,u.user_name createUserName, d.dept_name deptName " .
    " from inhe_project_participant k " .
...
<div style="text-align: right;width: 98%;margin:auto;">
    <?php if (strpos($type, '_change') == false) { ?>
        <div style="float: left;">
            <?if ($systemAdmin):?>
                <button class="layui-btn layui-btn-oa layui-btn-sm" onclick="pageOperate('new.php','add');return false;">新建</button>
            <?endif;?>
            <div class="dropdown">
            ...
            <?=$model->crm_help('project_participant');?>
        </div>
    <?php } ?>
