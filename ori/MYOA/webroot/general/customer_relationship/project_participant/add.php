        ...
        $(function() {
            layui.use(['form', 'layer'], function() {
                var layer = layui.layer,
                    form = layui.form;
                    layer.alert('项目参与人可以操作对应的项目，比如查看立项信息、立项变更、创建销售合同评审', {
                        icon: 0,
    ...
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="mainForm" class="layui-form">
            ...
            <table width="100%" align="center">
                        <td align="center">
                            <img alt="" src="../../../../../images/<?= $company ?>/project_participant.jpg" style="width: 34%; height: auto;" title="" />
                        </td>
                    </table>
                    <br />
                        ...
                        <table id="tab1" width="100%">
                            <tr>
                                ...
                                <input type="hidden" name="data_count" id="data_count" value="1" />
                                    ...
                                    <input class="layui-input" id="company" name="company" value="<?=$crm_process_sort[$company]["paras_desc"]?>">
                                </td>
                            </tr>
                            <tr >
                                <td nowrap class="TableContent">项目名称</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="project_code" id="project_name" class="layui-input mandatory" style="width: 220px;" readonly="readonly"  lay-verify="required"/>
                                </td>
                            </tr>
                            <tr hidden>
                            ...
                            <tr >
                                ...
                                <td nowrap class="TableData">
                                    <div class="layui-input-inline">
                                        <select id="customer_name" name="customer_name" readonly="readonly">
