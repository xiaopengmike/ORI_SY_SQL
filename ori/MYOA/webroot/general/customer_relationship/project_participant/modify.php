            ...
            layui.use(['form', 'layer'], function() {
                ...
                $("#project_name").click(function() {
                    ...
                    var index = layui.layer.open({
                        title: "项目代号列表",
                        type: 2,
                        content: "./project_list.php?user_bu="+user_bu,
                        area: ['600px', '650px'],
...
<body>
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="mainForm" class="layui-form">
            ...
            <input type="hidden" id="type" name="type" value="project_participant<?= $isChange ?>" />
            ...
            <table width="100%" align="center">
                        <td align="center">
                            <img alt="" src="../../../../../images/<?= $main[user_bu] ?>/project_participant.jpg" style="width: 34%; height: auto;" title="" />
                        </td>
                    </table>
                    <br />
                    ...
                    <td colspan="6">
                        ...
                        <tr>
                                ...
                                <input type="hidden" name="data_count" id="data_count" value="1" />
                                    ...
                                    <input class="layui-input" id="company" name="company" value="<?=$crm_process_sort[$main[user_bu]]["paras_desc"]?>">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td nowrap class="TableData">
                                    <input type="text" name="project_code" id="project_name" class="layui-input mandatory" style="width: 220px;" value="<?= $main['project_code'] ?>" readonly="readonly" lay-verify="required"/>
                                </td>
                            </tr>
                            <tr hidden>
                            ...
                            <tr hidden>
                                ...
                                <td nowrap class="TableData">
                                    <input type="text" name="customer_name" id="customer_name" class="layui-input" style="width: 220px;" value="<?= $main['customer_name'] ?>"  readonly="readonly"/>
                                </td>
                            </tr>
