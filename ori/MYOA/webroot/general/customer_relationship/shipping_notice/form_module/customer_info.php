<table id="tab1" width="100%" style="text-align: center;">
    <tr>
        ...
        <td class="TableData" width="19%">
            <input type="text" name="customer_name" id="customer_name" class="layui-input mandatory" value="<?= $main['customer_name'] ?>" lay-verify="required" />
        </td>
    ...
    <tr>
        ...
        <td class="TableData">
            <input type="text" name="shipment_time" id="shipment_time" class="layui-input date" value="<?= $main['shipment_time'] ?>" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="TableData">
            <input type="text" name="create_time" id="create_time" class="layui-input" value="<?= $time ?>" />
        </td>
    </tr>
    <tr>
    <td class=" TableContent">产品经理(客服)</td>
        ...
        <td class="TableData">
            <input type="text" name="batch_number" id="batch_number" class="layui-input" value="" />
        </td>
    </tr>
    
    <?endif;?>
    <?php if ($company == 'INHEGRID') { ?>
        <tr>
