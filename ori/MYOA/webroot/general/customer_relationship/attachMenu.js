...
function delete_attach(ATTACHMENT_ID,ATTACHMENT_NAME)
{
	...
	var ATTACH_PRIMARY_KEY_VALUE = jQuery('input[name=id]').val();
    if (window.confirm(msg)) {
        URL = "delete_attach.php?ATTACH_PRIMARY_KEY_VALUE="+ATTACH_PRIMARY_KEY_VALUE+"&DEL_ATTACHMENT_ID=" + ATTACHMENT_ID + "&DEL_ATTACHMENT_NAME=" + URLSpecialChars(ATTACHMENT_NAME);
        window.location = URL;
    }
}