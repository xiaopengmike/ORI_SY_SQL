...
$customer_names = implode("\n", $customer_names);
$customer_names = rtrim($customer_names, "\n");
...
<script type="text/javascript">
    ...
    <?php foreach($customer as $v): ?>
        customerData.set('<?=$v[id]?>',JSON.parse('<?= addslashes(td_json_encode($v));?>'));
    <?php endforeach; ?>
    ...
    <form id="mainForm" class="layui-form">
        <div style="width: 100%;height:auto;margin:auto;">
            ...
            <div class="weadmin-body" style="margin-top: 30px">
                ...
                <input type="hidden" name="type" id="type" value="customer_transfer<?= $isChange ?>" />
                ...
                <input type="hidden" name="customer_name" id="customer_name" value="<?= $main['customer_name'] ?>" />
                ...
                <tr>
                        ...
                        <td class="TableData" style="text-align: left;" colspan="3">
                        <input type="hidden" name="from_userid"  id="from_userid" value="<?=$main['from_userid']?>">
                        <textarea placeholder="原业务人员"  class="layui-textarea mandatory" id="from_userid_name" name="from_userid_name" value="<?= $main['from_username']?>" readonly lay-verify="required"><?= $main['from_username']?></textarea>
                        <!-- <a href="#" class="orgAdd" onClick="SelectUserSingle('','','from_userid', 'from_userid_name')" title="添加收件人">添加</a>
                                    <a href="#" class="orgClear" onClick="ClearUser('from_userid', 'from_userid_name')" title="清空收件人">清空</a><br> -->
                        </td>
                    </tr>
                    <tr>
                        ...
                        <textarea placeholder="新业务人员" onClick="SelectUserSingle('','','to_userid', 'to_userid_name')" class="layui-textarea mandatory" id="to_userid_name" name="to_userid_name" value="<?= $main['to_username']?>" readonly  lay-verify="required"><?= $main['to_username']?></textarea>
                    ...
                    <tr>
                        ...
                        <td class="TableData" style="text-align: left;" colspan="3">
                        <textarea class="layui-textarea mandatory" id="select_customer" name="select_customer" placeholder="点击选择客户" style="resize: auto;overflow: auto;" readonly lay-verify="required"><?=$customer_names?></textarea>
                        </td>
                    </tr>
                        <td class="TableContent" width="25%">转移原因</td>
                        <td class="TableData" colspan="3">
                            
                            <textarea class="layui-textarea mandatory" id="remark" name="remark" placeholder="转移原因" lay-verify="required"><?=$main[remark]?></textarea>
                        </td>
                    </tr>
                    <!-- <tr>
                                    <td class="TableHeader" colspan="4" align="center">转移客户</td>
                                </tr>
                                <tr>
                                <td class="TableContent" colspan="">客户名称</td>
                                    <td class="TableContent" colspan="">客户简称</td>
                                    <td class="TableContent" colspan="">大洲</td>
                                    <td class="TableContent" colspan="">国家</td>
                                </tr>
