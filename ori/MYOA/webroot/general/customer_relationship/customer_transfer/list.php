    ...
    <form id="tab" class="layui-form">
        ...
        <table style="margin: 1%">
            <tr>
                ...
                <td align="right">原业务人员</td>
                <td>
                    <input type="text" name="from_username" id="from_username" class="layui-input" placeholder="原业务人员">
                </td>
                <td align="right">新业务人员</td>
                <td>
                    <input type="text" name="to_username" id="to_username" class="layui-input" placeholder="新业务人员">
                </td>
