    ...
    <form id="tab" class="layui-form">
        ...
        <table style="margin: 1%">
            <tr>
                ...
                <td>
                    <input type="text" name="region" id="region" class="layui-input">
                </td>
                ...
                <td>
                    <div class="layui-input-inline">
                        <select id="progress_nodes" name="progress_nodes" lay-search>
                            <option value=''>请选择</option>
                            <?foreach($project_schedule_nodes as $k=>$v):?>
