...
if (empty($approverArr) || count($approverArr) == 0) {
    ...
    $sql = "update inhe_outsourcing_excipients set status = 'Y' where form_id = '" . $param['form_id'] . "' ";
...
$param['tableName'] = 'inhe_outsourcing_excipients';
        ...
        <div class="layui-form-item">
            ...
            <?php foreach ($approverArr as $app) {
                  ...
                  if(isset($approverArr[1])&&$actionType == '提交'){
                    ...
                    $param['江西总经理']=in_array('江西总经理',$role_names)?$param['E']:0;
