...
$selectParam = array(
    'is_used' => '1', // 可用参数
    'type' => 'project_star,check_opinion,yes_or_no,company,sample_request_material_flow,sample_request_material_type'
);
        ...
        $(function() {
            layui.extend({
                ...
                form.on('select(form_type)', function(data) {
                    ...
                    var url = "../../../../../images/<?= $main['user_bu'] ?>/trial_sample_comfirm_<?= $main['user_bu'] ?>.jpg";
                    if (formType == '02') {
                        url = "../../../../../images/<?= $main['user_bu'] ?>/stock_sample_comfirm_<?= $main['user_bu'] ?>.jpg";
                    }
    ...
    <div style="width: 100%;height:auto;margin:auto;">
        <form id="mainForm" class="layui-form">
            ...
            <div class="weadmin-body" style="width:90%;margin:1% 4%;">
                ...
                <input type="hidden" name="sup_form_id" id="sup_form_id" value="<?= $main[sup_form_id] ?>" />
                ...
                <table class="TableBlock" width="100%" align="center" border="2">
                    <tr>
                        <td>
                            <?php if ($main['type'] == 'trial_sample_comfirm') { ?>
