...
class updatePartNumeber extends Action
{
    
    private function updatePartNumeberData()
    {
        
        $model = new ActionModel();
        $result = $model->updatePartNumeber();
    ...
    public function operation()
    {
        $this->updatePartNumeberData();
    }
}

class updatePurchasePartNumeber extends Action
{
    
    private function updatePurchasePartNumeberData()
    {
        
        $model = new ActionModel();
        $result = $model->updatePurchasePartNumeber();
    ...
    public function operation()
    {
        $this->updatePurchasePartNumeberData();
    }
}
