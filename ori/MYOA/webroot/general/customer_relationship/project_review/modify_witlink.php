        ...
        <form id="mainForm" class="layui-form">
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        <td colspan="6">
                            <?php include_once("change/witlink/customer_info.php"); ?>
                            <?php include_once("change/witlink/project_situation.php"); ?>
                            <?php include_once("change/witlink/bidding_strategy.php"); ?>
                        </td>
                    </tr>
                </table>
            </div>
