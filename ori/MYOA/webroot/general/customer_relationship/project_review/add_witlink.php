        ...
        <form id="mainForm" class="layui-form">
            ...
            <div class="weadmin-body" style="width:90%;margin:1% 4%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        <td colspan="6">
                            <?php include_once("form_module/witlink/customer_info.php"); ?>
                            <?php include_once("form_module/witlink/project_situation.php"); ?>
                            <?php include_once("form_module/witlink/bidding_strategy.php"); ?>
                        </td>
                    </tr>
                </table>
            </div>
