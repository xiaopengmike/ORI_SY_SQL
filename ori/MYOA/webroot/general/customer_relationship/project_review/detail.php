...
if ($main['user_bu']=='WITLINK'){
    header("Location: detail_witlink.php?".$_SERVER['QUERY_STRING']);
    exit;
}
...
<head>
    ...
    <script language="Javascript" type="text/javascript" src="../detail.js?v=20250310"></script>
    ...
    <script type="text/javascript">
        ...
        function getNextApprover(formId, actionType) {
            ...
            layer.open({
                ...
                type: 2,
                area: ['600px', '80%'],
                content: "next_approver.php?step=" + step + "&user_bu=" + user_bu + "&form_id=" + formId + "&actionType=" + actionType + "&type=" + type + "&E=" + E + "&S=" + S + "&N=" + N + "&G=" + G+ "&D=" + D+"&is_collective="+is_collective,
