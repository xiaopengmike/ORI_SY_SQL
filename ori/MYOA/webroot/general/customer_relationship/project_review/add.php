...
if ($company=='INHENERGY'||$company=='HKNERGY'){
    header("Location: add_inhenergy.php?company=".$company);
    exit;
}
if ($company=='WITLINK'){
    header("Location: add_witlink.php?company=WITLINK");
    exit;
}
$selectParam = array(
    'is_used' => '1', // 可用参数
        ...
        layui.extend({
            ...
            $("#project_code").blur(function() {
                ...
                var index = layui.layer.open({
                    ...
                    type: 2,
                    area: ['600px', '500px'],
                    content: "get_project_code.php?company="+$('#user_bu').val(),
            ...
            <div class="weadmin-body" style="width:90%;margin:1% 4%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    <tr>
                        ...
                        <td class="TableData" width="18%"><?= $_SESSION['LOGIN_USER_NAME'] ?></td>
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <?php include_once("form_module/project_situation.php"); ?>
                            <?php include_once("form_module/bidding_strategy.php"); ?>
                        </td>
                    </tr>
                </table>
            </div>
