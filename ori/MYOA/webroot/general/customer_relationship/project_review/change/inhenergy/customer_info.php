<table id="tab1" width="100%" style="text-align: center;">
    ...
    <tr>
        ...
        <td class="TableData" colspan="3">
            <textarea class="layui-textarea" id="cooperate_history" name="cooperate_history" lay-verify="required" ><?= $project['cooperate_history'] ?></textarea>
        </td>
        <td class=" TableContent">添加附件：</td>
        <td class="TableData" style="text-align: left;">
    ...
    <tr>
        ...
        <td class="TableData" align="left">
            ...
            <?if($changeStar!=1):?>
                ...
                <?else:?>
                    <select id="name3" name="name3" lay-search lay-filter="customer_name" title="3">
