<table id="tab3" class="is_bidding_project" width="100%" style="text-align: left;">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="partner_analysis" name="partner_analysis"  <?if($changeStar!=1):?>lay-verify="required"<?endif?>><?= $bidding['partner_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="relationship" name="relationship"  <?if($changeStar!=1):?>lay-verify="required"<?endif?>><?= $bidding['relationship'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="market_analysis" name="market_analysis"  <?if($changeStar!=1):?>lay-verify="required"<?endif?>><?= $bidding['market_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="strategy_analysis" name="strategy_analysis"  <?if($changeStar!=1):?>lay-verify="required"<?endif?>><?= $bidding['strategy_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData" colspan="3">
            <textarea class="layui-textarea is_bidding" id="key_to_success" name="key_to_success"  <?if($changeStar!=1):?>lay-verify="required"<?endif?>><?= $bidding['key_to_success'] ?></textarea>
        </td>
    </tr>
    <tr>
