<table id="tab2" width="100%" style="text-align: left;">
    ...
    <tr>
        ...
        <td class="TableData" width="35%">
            <input readonly type="text" name="project_code" id="project_code" class="layui-input" value="<?= $project['project_code'] ?>" autocomplete="off" <?if($changeStar!=1):?>lay-verify="required" <?endif;?>/>
            ...
            <table id="tab21" width="100%">
                ...
                foreach ($projectDetail[$product_type['paras_value']] as $tk => $v) :
                    ...
                    <tr align="center">
                        ...
                        <td class="TableData">
                            <input type="hidden" name="serial_number<?=$i?>" id="serial_number" class="layui-input" value="<?=$i?>"/>
