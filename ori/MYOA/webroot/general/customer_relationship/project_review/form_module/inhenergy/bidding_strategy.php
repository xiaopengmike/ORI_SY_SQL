<table id="tab3" class="is_bidding_project" width="100%" style="text-align: left;">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding"  id="partner_analysis" name="partner_analysis" ><?= $bidding['partner_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="relationship" name="relationship" ><?= $bidding['relationship'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="market_analysis" name="market_analysis" ><?= $bidding['market_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea is_bidding" id="strategy_analysis" name="strategy_analysis" ><?= $bidding['strategy_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData" colspan="3">
            <textarea class="layui-textarea is_bidding" id="key_to_success" name="key_to_success" ><?= $bidding['key_to_success'] ?></textarea>
        </td>
    </tr>
    <tr>
...
<tr>
        <td class="TableContent"  width="15%">个人意见</td>
        <td colspan="3">
            <table id="tab31" width="100%" style="text-align: center;">
                ...
                <tr>
                    <td colspan="6" class="TableData" align="left"><input type="text" name="signature" id="signature" class="layui-input" readonly  value="<?=$_SESSION['LOGIN_USER_NAME']?> <?=date("Y-m-d H:i:s")?>" /></td>
                </tr>
            </table>
        </td>
    </tr>
