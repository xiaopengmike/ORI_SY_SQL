<table id="tab3" width="100%" style="text-align: left;">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea" id="partner_analysis" name="partner_analysis" lay-verify="required"><?= $bidding['partner_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea" id="relationship" name="relationship" lay-verify="required"><?= $bidding['relationship'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea" id="market_analysis" name="market_analysis" lay-verify="required"><?= $bidding['market_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData">
            <textarea class="layui-textarea" id="strategy_analysis" name="strategy_analysis" lay-verify="required"><?= $bidding['strategy_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
    ...
    <tr>
        ...
        <td class="TableData" colspan="3">
            <textarea class="layui-textarea" id="key_to_success" name="key_to_success" lay-verify="required"><?= $bidding['key_to_success'] ?></textarea>
        </td>
    </tr>
    <tr>
        <td class="TableContent">20.项目可行性分析会议纪要（铁三角）</td>
        <td class="TableData">
            <textarea class="layui-textarea" id="feasibility_analysis" name="feasibility_analysis" lay-verify="required" ><?= $bidding['feasibility_analysis'] ?></textarea>
        </td>
        <td class="TableContent" width="15%">添加附件：</td>
        <td class="TableData">
