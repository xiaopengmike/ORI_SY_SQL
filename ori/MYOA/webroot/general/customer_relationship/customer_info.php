<table id="tab1" width="100%" style="text-align: center;">
    <tr>
        ...
        <td class="TableData">
            <input type="text" name="order_num" id="order_num" class="layui-input" lay-verify="required"/>
        </td>
        ...
        <td class="TableData" width="15%">
            <input type="text" name="project_num" id="project_num" class="layui-input" lay-verify="required" />
        </td>
