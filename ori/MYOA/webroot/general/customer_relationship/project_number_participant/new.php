                    ...
                    <td>
                        <table id="tab1" width="100%">
                            ...
                            <tr>
                                ...
                                <td nowrap class="TableData">
                                    <input type="text" name="project_number" id="project_number" class="layui-input" style="width: 220px;" />
                                </td>
                            </tr>
                            <tr>
                                <td nowrap class="TableContent" width="15%">客户名称</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="customer_name" id="customer_name" class="layui-input" style="width: 220px;" />
                                </td>
                            </tr>
                        </table>
