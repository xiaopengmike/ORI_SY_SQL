...
$where = " where 1=1 and m.type='sales_contract_review' and m.user_bu='$user_bu'";
$pageLimit = "";
...
if (empty($param['project_number'])&& empty($param['project_code'])) {
    $where .= " and 1=2 ";
}
...
if (array_key_exists("project_code", $param) && $param['project_code'] != "") {
    $where .= " and m.project_name = '" . trim($param['project_code']) . "' ";
}
