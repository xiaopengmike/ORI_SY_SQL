            ...
            layui.use(['form', 'layer'], function() {
                ...
                $("#project_number").click(function() {
                    var index = layui.layer.open({
                        title: "项目编号列表",
                        type: 2,
                        content: "../common/list/project_number_list.php",
                        area: ['600px', '650px'],
...
<body>
    <div class="weadmin-body" style="width:80%;margin:1% 9%;">
        <form id="mainForm" class="layui-form">
            ...
            <input type="hidden" name="flowType" value="mencn" />
            <input type="hidden" name="reset" value="day" />
            <input type="hidden" name="digit" value="2" />
            <input type="hidden" id="type" name="type" value="project_number_participant_change" />
                    ...
                    <td colspan="6">
                        <table id="tab1" width="100%">
                            ...
                            <tr>
                                ...
                                <td nowrap class="TableData">
                                    <input type="text" name="project_number" id="project_number" class="layui-input" style="width: 220px;" value="<?= $main['project_number'] ?>" />
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table id="tab2" width="100%">
                            ...
                            foreach ($detail as $val) : $i++; ?>
                                <tr align="center">
                                    ...
                                    <td nowrap class="TableData" width="15%"><input type="hidden" name="user_item<?= $i ?>" id="user_item<?= $i ?>" class="layui-input" value="<?= $i ?>" /><?= $i ?></td>
                                    <td nowrap class="TableData" width="35%"><input type="text" name="user_name<?= $i ?>" id="user_name<?= $i ?>" class="layui-input" value="<?= $val['user_name'] ?>" onclick="getUserSelect(this);return false;" /></td>
                                    <td nowrap class="TableData"><input type="text" name="proportion<?= $i ?>" id="proportion<?= $i ?>" class="layui-input" value="<?= $val['proportion'] ?>" /></td>
                                </tr>
                            <?php endforeach; ?>
