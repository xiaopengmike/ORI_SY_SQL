        ...
        $(function() {
            layui.use(['form', 'layer'], function() {
                var layer = layui.layer,
                    form = layui.form;
                    layer.alert('项目编号参与人可以获取该个合同权限，比如合同变更、创建变更生产通知单、创建发货通知单，一个合同存在一个项目编号', {
                        icon: 0,
    ...
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="mainForm" class="layui-form">
            ...
            <table width="100%" align="center">
                        <td align="center">
                            <img alt="" src="../../../../../images/<?= $company ?>/project_number_participant.jpg" style="width: 34%; height: auto;" title="" />
                        </td>
                    </table>
                    <br />
                    ...
                    <td>
                        <table id="tab1" width="100%">
                            <tr>
                                ...
                                <input type="hidden" name="data_count" id="data_count" value="1" />
                                    ...
                                    <input class="layui-input" id="company" name="company" value="<?=$crm_process_sort[$company]["paras_desc"]?>" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap class="TableContent" width="15%">项目编号</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="project_number" id="project_number" class="layui-input mandatory" style="width: 220px;" placeholder="请点击选择" readonly="readonly" lay-verify="required"/>
                                </td>
                            </tr>
                            <tr hidden>
                                <td nowrap class="TableContent" width="15%">所属部门</td>
                                <td nowrap class="TableData">
                                    <input type="text" id="menu_parent_name" class="layui-input" data-type="dept_select" name="dept_name" style="width: 220px;" readonly/>
                                    <input type="hidden" id="menu_parent" name="menu_parent">
                                </td>
                            </tr>
                            <tr >
                                <td nowrap class="TableContent" width="15%">项目名称</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="project_name" id="project_name" class="layui-input" style="width: 220px;" readonly/>
                                </td>
                            </tr>
                            <tr >
                                <td nowrap class="TableContent" width="15%">客户名称</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="customer_name" id="customer_name" class="layui-input" style="width: 220px;" readonly />
                                </td>
                            </tr>
                        ...
                        <table id="tab2" width="100%">
                            ...
                            <tr align="center">
                                ...
                                <td class="TableData" colspan="2">
                                    <input type="text" name="leader_proportion" id="leader_proportion" data-type="proportion" class="layui-input border-solid" onkeyup="clearNoNum(this);" />
                                </td>
                            </tr>
                            <tr align="center">
