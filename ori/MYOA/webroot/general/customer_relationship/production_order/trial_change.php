...
$selectParam = array(
    'is_used' => '1', // 可用参数
    'type' => 'project_star,check_opinion,yes_or_no,inspection_type,display_mode,
            production_mode,test_report,packed_in_sequence,form_type,product_brand,product_detail_type,company,SGC_TYPE'
);
...
//存在变更，则取上次变更信息继续变更
if($main['version']>0){
    $item=$dataModel->getLastChange($main['form_id'],$main['version'],'trial_production_order_change');
    if($item['form_id']){
...
<head>
    ...
    <script language="Javascript" type="text/javascript" src="main.js?v=20240913"></script>
    ...
    <div style="width: 100%;height:auto;margin:auto;">
        <form id="mainForm" class="layui-form">
            ...
            <div class="weadmin-body" style="width:90%;margin:1% 4%;">
                ...
                <input type="hidden" name="flowType" value="scbg" />
                ...
                <table width="100%" align="center">
                    <tr>
                            <td align="center">
                            <?if($main[form_type]=="01"):?>
                            <img alt="" id="page_title" src="../../../../../images/<?= $company ?>/trial_production_order_change_<?= $company ?>.jpg" style="width: 34%; height: auto;" title="" />
                            <?elseif($main[form_type]=="02"):?>
                                <img alt="" id="page_title" src="../../../../../images/<?= $company ?>/stock_production_order_change_<?= $company ?>.jpg" style="width: 34%; height: auto;" title="" />
                                <?elseif($main[form_type]=="03"):?>
                                    <img alt="" id="page_title" src="../../../../../images/<?= $company ?>/Replenishment_production_order_change_<?= $company ?>.jpg" style="width: 34%; height: auto;" title="" />
                                    <?elseif($main[form_type]=="04"):?>
                                    <img alt="" id="page_title" src="../../../../../images/<?= $company ?>/risk_production_order_change_<?= $company ?>.jpg" style="width: 34%; height: auto;" title="" />
                                    <?endif;?>
                        </td>
                    </tr>
                    <tr>
