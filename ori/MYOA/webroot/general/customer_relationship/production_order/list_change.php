...
<body class="bodyColorNew">
    <form id="tab" class="layui-form">
        <input type="hidden" id="type" name="type" value="production_order_change,trial_production_order_change" />
                ...
                <td>
                    <div class="layui-input-inline">
                        <select id="form_type" name="form_type">
                            <option value=''>请选择</option>
                            <option value='11'>正式生产通知单</option>
                            <option value='04'>风险生产通知单</option>
                            <option value='03'>售后服务生产通知单</option>
                            <option value='02'>备货生产通知单</option>
                            <option value='01'>原试生产通知单</option>
                        </select>
                    </div>
                </td>
