...
$date = date('Y-m-d');
$systemId = "project_team";
if (!empty($type)) $systemId = $type;
$userdata = $userModel->getAdminDataQuery($userId, $deptId, $systemId);
$isAdmin = $userdata['isAdmin'];
$systemAdmin = $userdata['systemAdmin'];
$user_ids = $userdata['userIds'];
$dept_ids = $userdata['deptIds'];
        ...
        <form id="mainForm" class="layui-form" lay-filter="mainForm">
            ...
            <input type="hidden" name="fieldName" value="form_id" />
                ...
                <tr>
                    ...
                    <tr <?if(strpos($dept_ids,'01') === false):?>class="hiddenClass"<?endif;?>>
                    ...
                    <tr <?if(strpos($dept_ids,'02') === false):?>class="hiddenClass"<?endif;?>>
                    ...
                    <tr <?if(strpos($dept_ids,'03') === false):?>class="hiddenClass"<?endif;?>>
