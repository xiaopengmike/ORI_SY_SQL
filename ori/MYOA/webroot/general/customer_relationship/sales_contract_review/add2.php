...
$selectParam = array(
    ...
    company,product_brand,product_detail_type,company,funds_come,product_project_type,license_product,license_type',
);
    ...
    <script>
        $(function() {    
            layui.extend({
                ...
                //电网提交增加判断
                if($("#user_bu").val()=='INHEGRID'||$("#user_bu").val()=='INHENERGY'||$("#user_bu").val()=='HKNERGY'){
