...
$selectParam = array(
    'is_used' => '1', // 可用参数
    'type' => 'project_star,currency,yes_or_no,quote_source,sale_model,auto_flow_user,
...
//存在变更，则取上次变更信息继续变更
if($main['version']>0){
    $item=$dataModel->getLastChange($main['form_id'],$main['version'],'sales_contract_review_change');
    if($item['form_id']){
    ...
    <div style="width: 100%;height:auto;margin:auto;">
        <form id="mainForm" class="layui-form">
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                ...
                <input type="hidden" name="flowType" value="ddbg" />
                ...
                <table width="100%" align="center">
                    <tr>
                        <td align="center">
                            <img alt="" src="../../../../../images/<?= $main['user_bu'] ?>/sales_contract_review_change_<?= $main['user_bu'] ?>.jpg" style="width: 34%; height: auto;" title="" />
                        </td>
                    </tr>
                    <tr>
                        <td>
