        ...
        <form id="addForm" class="layui-form">
            ...
            <table class="layui-table" border="0" cellpadding="0" cellspacing="10" lay-size="sm">
                <tr>
                    ...
                    <td>
                        <input type="text" name="project_code" id="project_code" class="layui-input" lay-verify="required" />
                    </td>
                    <td class="layui-bg-gray">保函类型</td>
                    <td>
                        <div class="layui-input-inline mandatory">
                            <select id="bid_type" name="bid_type" lay-search lay-verify="required">
                    ...
                    <td>
                        <div class="layui-input-inline mandatory">
                            <select id="opening_time" name="opening_time" lay-search lay-verify="required">
                                <option value=''>请选择</option>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="effective_date" id="effective_date" class="layui-input date" lay-verify="required"/>
                    </td>
                    <td class="layui-bg-gray">到期日期</td>
                    <td>
                        <input type="text" name="end_date" id="end_date" class="layui-input date" lay-verify="required"/>
                    </td>
                    <td class="layui-bg-gray">国内银行费用</td>
                    <td>
                        <input type="text" name="bank_charge" id="bank_charge" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">转开行费用</td>
                    <td>
                        <input type="text" name="transfer_fee" id="transfer_fee" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="guarantee_amount" id="guarantee_amount" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">保证金金额</td>
                    <td>
                        <input type="text" name="margin_amount" id="margin_amount" class="layui-input" lay-verify="required" />
                    </td>
                    <td class="layui-bg-gray">占用额度</td>
                    <td>
                        <input type="text" name="occupation_quota" id="occupation_quota" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">国内开立银行</td>
                    <td>
                        <input type="text" name="opening_bank" id="opening_bank" class="layui-input" lay-verify="required"/>
                    </td>
                    <td class="layui-bg-gray">国外转开行（若有）</td>
                    <td>
                        <input type="text" name="transfer_bank" id="transfer_bank" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">项目所在国</td>
                    <td>
                        <input type="text" name="project_country" id="project_country" class="layui-input" lay-verify="required" />
                    </td>
                    <td class="layui-bg-gray">保函审批流程流水号</td>
                    <td>
                        <input type="text" name="flow_no" id="flow_no" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="layui-input-inline" style="width: 220px;">
                            <input type="text" id="menu_parent_name" class="layui-input" data-type="dept_select" name="apply_dept_name" style="width: 220px;" />
                    ...
                    <td>
                        <div class="layui-input-inline" style="width: 220px;">
                            <input type="hidden" id="business_leader" name="business_leader" value="" />
                    ...
                    <td>
                        <input type="text" name="commerce_manager" id="commerce_manager" class="layui-input" />
                    </td>
                    ...
                    <td>
                        <div class="layui-input-inline mandatory">
                            <select id="manage_dept" name="manage_dept" lay-search lay-verify="required">
                                <option value=''>请选择</option>
                                <?php foreach ($selectArr['manage_dept_grid'] as $md) : ?>
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <input type="button" id="apply_attach_grid" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">国内银行电文</td>
                    <td colspan="7">
                        <input type="button" id="bank_attach_grid" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">转开行最终保函</td>
                    <td colspan="7">
                        <input type="button" id="transfer_attach_grid" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
