...
$selectParam = array(
    'is_used' => '1', // 可用参数
    'type' => 'yes_or_no,manage_dept_grid',
);
...
<body>
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="addForm" class="layui-form">
            <input type="hidden" name="form_type" id="form_type" value="guarantee_letter_grid" />
            ...
            <table class="layui-table" border="0" cellpadding="0" cellspacing="10" lay-size="sm">
                <tr>
                    ...
                    <td>
                        <input type="text" name="country" id="country" class="layui-input" lay-verify="required" />
                    </td>
                    <td class="layui-bg-gray">被授权人</td>
                    <td>
                        <input type="text" name="authorized_person" id="authorized_person" class="layui-input" lay-verify="required" />
                    </td>
                    <td class="layui-bg-gray">相对方</td>
                    <td>
                        <input type="text" name="contract_party" id="contract_party" class="layui-input" lay-verify="required" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-input-inline" style="width: 220px;">
                            <input type="hidden" id="apply_name" name="apply_name" value="" />
                    ...
                    <td>
                        <input type="text" name="archive_mode" id="archive_mode" lay-verify="required" class="layui-input" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <input type="button" id="guarantee_letter_grid" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
