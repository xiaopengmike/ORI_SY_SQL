                ...
                switch (obj.event) {
                    case 'delete':
                        ...
                        layer.confirm('确定要删除当前记录吗？', {
                            ...
                            var url = '../action.php?action=Delete&id=' + deleteData.id + '&tableName=inhe_guarantee_letter';
                    ...
                    case 'detail':
                        ...
                        var index = layui.layer.open({
                            title: "详情",
                            type: 2,
                            content: "../detail/detail4.php?id=" + infoData.id,
                            success: function(layero, index) {
                                setTimeout(function() {
                                    layui.layer.tips('点击此处返回列表', '.layui-layer-setwin .layui-layer-close', {
                                        tips: 3
                    ...
                    case 'modify':
                        ...
                        var index = layui.layer.open({
                            title: " 编辑数据",
                            type: 2,
                            content: "../modify/modify4.php?id=" + infoData.id,
                            success: function(layero, index) {
                                setTimeout(function() {
                                    layui.layer.tips('点击此处返回列表', '.layui-layer-setwin .layui-layer-close', {
                                        tips: 3
