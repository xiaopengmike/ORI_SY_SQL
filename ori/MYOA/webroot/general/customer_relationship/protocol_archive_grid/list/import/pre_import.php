...
if ($templateName == '' || $templateName == null) {
    $templateName = 'template';     // 默认模板名称定为templet.xls
}
?>
<script>
    function CheckForm2() {
        ...
        <form name="form2" method="post" action="import.php" enctype="multipart/form-data" onSubmit="return CheckForm2();">
            ...
            <tr class="TableData" align="center" height="30">
                ...
                <td width="400" align="left">
                    <a href="#" onClick="window.location='template/<?= $templateName ?>.xls'">导入模板下载</a>
                </td>
            </tr>
            <tr class="TableData" align="center" height="30">
                <td width="150" align="right">
            ...
            <tr>
                <td  class="TableControl" colspan="3" align="center">
