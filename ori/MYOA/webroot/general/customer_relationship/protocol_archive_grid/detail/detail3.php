        ...
        <form id="addForm" class="layui-form">
            ...
            <table class="layui-table" border="0" cellpadding="0" cellspacing="10" lay-size="sm">
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <input id="apply_attach_grid" type="button" class="layui-btn layui-bg-gray btn-upload" style="display: none;" value="附件上传" readonly />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">国内银行电文</td>
                    <td colspan="7">
                        <input id="bank_attach_grid" type="button" class="layui-btn layui-bg-gray btn-upload" style="display: none;" value="附件上传" readonly />
                </tr>
                <tr>
                    <td class="layui-bg-gray">转开行最终保函</td>
                    <td colspan="7">
                        <input id="transfer_attach_grid" type="button" class="layui-btn layui-bg-gray btn-upload" style="display: none;" value="附件上传" readonly />
                    </td>
                </tr>
            </table>
        </form>
