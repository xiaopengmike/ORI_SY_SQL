...
$sql = " select m.*, t.id attachId, t.filename attachName, t.path attachUrl from inhe_contract_protocol_grid m "
    . "left join inhe_attachment t on t.type = 'contract_protocol_grid' and t.relatedId = m.id "
    . $where . $orderBy . $pageLimit;
$countSql = " select count(*) total_count from inhe_contract_protocol_grid m " . $where . $orderBy;
