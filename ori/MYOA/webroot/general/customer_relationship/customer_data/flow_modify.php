...
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['新增跟进记录'][$_COOKIE['LANG']]);
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        ...
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="need" name="need" placeholder="<?=$LG_CUSTOMER_DATA['需求'][$_COOKIE['LANG']]?>" autocomplete="off"><?= $flow[need] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <select name="order_will" id="order_will" class="normalSelect">
                                    <option value=""><?=$LG_CUSTOMER_DATA['请选择'][$_COOKIE['LANG']]?></option>
                                    <option value='Y' <?php if ($flow['order_will'] == 'Y') : ?>selected<?php endif; ?>><?=$LG_CUSTOMER_DATA['是'][$_COOKIE['LANG']]?></option>
                                     <option value='N' <?php if ($flow['order_will'] == 'N') : ?>selected<?php endif; ?>><?=$LG_CUSTOMER_DATA['否'][$_COOKIE['LANG']]?></option>
                                    </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="remark" name="remark" placeholder="<?=$LG_CUSTOMER_DATA['商谈事项'][$_COOKIE['LANG']]?>" autocomplete="off"><?= $flow[remark] ?></textarea>
                        </td>
                    </tr>
                </table>
            </div>
