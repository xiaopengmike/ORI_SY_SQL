...
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['联系人'][$_COOKIE['LANG']]);
                    ...
                    <table id="tab" width="100%">
                        <tr class="layui-bg-body">
                            <td style="padding: 5px;">
                                <input lay-submit  name="btn_submit" actionType="Save" value="<?=$LG_CUSTOMER_DATA['提交'][$_COOKIE['LANG']]?>" type=submit type=button class="layui-btn layui-btn-oa layui-btn-sm" />
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        ...
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="remark" name="remark" placeholder="<?=$LG_CUSTOMER_DATA['备注'][$_COOKIE['LANG']]?>" autocomplete="off"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
