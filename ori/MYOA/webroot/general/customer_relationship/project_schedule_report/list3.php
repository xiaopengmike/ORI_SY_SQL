...
layui.use('table', function() {
    ...
    table.render({
        ...
        height: 312,
        url: "report_data/get_schedule.php" //数据接口
            ,
        method: 'post',
        page: false, // 不分页
        ...
        cols: [
             ...
             */
            layuiRowspan(['0','progress_nodes','region','business_user_name'],"0",true,"progress_nodes");
        }
    });
    ...
    table.on('toolbar(door_userprocess)', function(obj){
        ...
        switch(obj.event){
            case 'getExcel':
                //请求所有数据
                $.ajax({
                    url: 'report_data/get_schedule.php?page=1&limit=1000',
                    type: 'post',
                    async: false,
                    dataType: 'json',
                    data: {
