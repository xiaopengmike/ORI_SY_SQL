...
/**
 * 表说明：
 * inhe_contract_protocol_nergy  数据主表 insert or update
 * inhe_control_library_history 历史记录表 insert
 */

class ActionModel
{
    public $systemId = "contract_protocol_nergy";
    ...
    public function query($param)
    {
        ...
        $sql = " select k.* from inhe_contract_protocol_nergy k " . $strWhere . $orderBy . $limit;
    ...
    public function queryMain($param)
    {
        ...
        $sql = " select k.*,u.user_name createUserName, uu.user_name applyUserName, d.dept_name deptName from inhe_contract_protocol_nergy k " .
    ...
    public function querySalesContract($param)
    {
        ...
        $sql = " select k.* from inhe_sales_contract_nergy k " . $strWhere;
        $res = exequery(TD::conn(), $sql);
    ...
    public function queryAuthorizationLetter($param)
    {
        ...
        $sql = " select k.* from inhe_authorization_letter_nergy k " . $strWhere;
        $res = exequery(TD::conn(), $sql);
    ...
    public function add($param)
    {
        ...
        if ($param['form_type'] == 'contract_protocol_nergy') {
        ...
        if ($param['form_type'] == 'guarantee_letter_nergy') {
    ...
    public function addContractProtocol($param)
    {
        ...
        $sql = " select max(serial_number)+1 newNumber from inhe_contract_protocol_nergy ";
        $res = exequery(TD::conn(), $sql);
        $item = mysql_fetch_assoc($res);
        $newNumber = $item['newNumber'];

        $mainSql = "insert into inhe_contract_protocol_nergy (dept_id,
        create_user,
        create_time,
        title,
        serial_number,
    ...
    public function addSalesContract($param)
    {
        ...
        $sql = " select max(serial_number)+1 newNumber from inhe_sales_contract_nergy ";
        $res = exequery(TD::conn(), $sql);
        $item = mysql_fetch_assoc($res);
        $newNumber = $item['newNumber'];

        $mainSql = "insert into inhe_sales_contract_nergy (organ_id,
        user_id,
        create_time,
        title,
        serial_number,
    ...
    public function addAuthorizationLetter($param)
    {
        ...
        $mainSql = "insert into inhe_authorization_letter_nergy (organ_id,
        user_id,
        create_time,
        title,
        project_code,
    ...
    public function updateAttachLink($id)
    {
        ...
        $updateSql = " update inhe_contract_protocol_nergy set attach_id ='" . $attachInfo['id'] . "',attach_name='" . $attachInfo['filename'] . "' where id='" . $id . "' ";
    ...
    public function updateContractProtocol($param)
    {
        ...
        $mainSql = "update inhe_contract_protocol_nergy set update_time = '" . $time . "', continent='" . $param['continent'] . "', country='" . $param['country'] . "', "
    ...
    public function updateSalesContract($param)
    {
        ...
        $mainSql = "update inhe_sales_contract_nergy set update_time = '" . $time . "', sign_date='" . $param['sign_date'] . "', contract_category='" . $param['contract_category'] . "', "
    ...
    public function updateAuthorizationLetter($param)
    {
        ...
        $mainSql = "update inhe_authorization_letter_nergy set update_time = '" . $time . "', project_code='" . $param['project_code'] . "', bid_type='" . $param['bid_type'] . "', "
