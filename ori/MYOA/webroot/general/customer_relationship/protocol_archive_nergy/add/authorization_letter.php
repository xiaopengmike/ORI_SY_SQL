...
$param = array(
    'fieldName' => 'form_id',
    'tableName' => 'inhe_contract_protocol_nergy',
...
<body>
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="addForm" class="layui-form">
            ...
            <input type="hidden" name="tableName" value="inhe_contract_protocol_nergy" />
            <input type="hidden" name="flowType" value="sctz" />
            <input type="hidden" name="reset" value="day" />
            <input type="hidden" name="digit" value="2" />
            <input type="hidden" name="type" value="contract_protocol_nergy" />
