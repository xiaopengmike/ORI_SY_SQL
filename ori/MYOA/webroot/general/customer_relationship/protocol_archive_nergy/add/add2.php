...
$selectParam = array(
    'is_used' => '1', // 可用参数
    'type' => 'yes_or_no,contract_category,manage_dept_nergy,currency'
);
    ...
    <script type="text/javascript">
                ...
                $("#project_no").on({
                    mouseleave:function(){
                        $.ajax({
                            type:'GET',
                            dataType:'JSON',
                            data:{project_number:$('#project_no').val()},
                            url:'../get_contract_data.php',
                            success:function(res){
                                if(res.code=='200'){
                                    returnProductData(res.data[0]);
                                }
        ...
        function returnProductData(reData) {
            layui.use(['form', 'layer'], function() {
                 ...
                 $("#project_no").val(reData.project_number);
                 $("#contract_no").val(reData.form_id);
                 $("#contract_party").val(reData.contract_party);
                 $("#business_belong").val(reData.business_attribution);
                 $("#amount").val(reData.total_amount);
                 $("#currency").val(reData.currency);
                 $("#menu_parent").val(reData.dept_id);
                 $("#menu_parent_name").val(reData.dept_name);
                 $("#create_user").empty();
                 $("#create_user").append("<option value=''>请选择</option>");
                 $("#create_user").append("<option value='" + reData.create_user + "' selected='selected'>" + reData.create_user_name + "</option>");
        ...
        <form id="addForm" class="layui-form">
            ...
            <table class="layui-table" border="0" cellpadding="0" cellspacing="10" lay-size="sm">
                <tr>
                    ...
                    <td>
                        <input type="text" name="sign_date" id="sign_date" class="layui-input date" lay-verify="required" />
                    </td>
                    ...
                    <td>
                        <input type="text" name="project_name" id="project_name" lay-verify="required" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">项目编号</td>
                    <td>
                        <input type="text" name="project_no" id="project_no" lay-verify="required" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">合同编号</td>
                    <td>
                        <input type="text" name="contract_no" id="contract_no" lay-verify="required" class="layui-input" />
                    </td>
                    ...
                    <td colspan="3">
                        <input type="text" name="amount" id="amount" lay-verify="required" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">客户名称</td>
                    <td>
                        <input type="text" name="customer_name" id="customer_name" lay-verify="required" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">合同相对方</td>
                    <td>
                        <input type="text" name="contract_party" id="contract_party" lay-verify="required" class="layui-input" />
                    </td>
                    <td class="layui-bg-gray">业务归属</td>
                    <td colspan="3">
                        <input type="text" name="business_belong" id="business_belong" class="layui-input" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="layui-input-inline" style="width: 220px;">
                            <input type="text" id="menu_parent_name" class="layui-input" data-type="dept_select" name="dept_name" style="width: 220px;" />
                    ...
                    <td>
                        <div class="layui-input-inline" style="width: 220px;">
                            <input type="hidden" id="create_user_name" name="create_user_name" value="" />
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <input type="button" id="foreign_attach_nergy" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">中文翻译件</td>
                    <td colspan="7">
                        <input type="button" id="chinese_attach_nergy" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
