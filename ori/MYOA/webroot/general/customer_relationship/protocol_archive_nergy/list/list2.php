...
<body style="background-color: white;">
    ...
    <script>
                ...
                cols: [
                    [
                        // {type: 'checkbox', fixed: 'left'},
                        {
                            ...
                            field: 'foreign_attach_nergy',
                            title: '外文附件',
                            templet: foreignAttachLink,
                            align: 'center'
                        }, {
                            field: 'chinese_attach_nergy',
                            title: '中文翻译件',
                ...
                switch (obj.event) {
                    case 'delete':
                        ...
                        layer.confirm('确定要删除当前记录吗？', {
                            ...
                            var url = '../action.php?action=Delete&id=' + deleteData.id + '&tableName=inhe_sales_contract_nergy';
        ...
        function foreignAttachLink(d) {
            var attachName = d.foreign_attach_nergy;
            ...
            if (attachName.length > 0) {
                var attachUrl = '<a class="layui-blue" href="javascript:void(0);" lay-event="file" onclick="openFullModel(\'/attachment/reportshop/attachment/' +
                    d.foreign_attach_nergy + '\');return false;">附件下载</a>';
                return attachUrl;
            }
        }

        function chineseAttachLink(d) {
            var attachName = d.chinese_attach_nergy;
            if ('' == attachName || null == attachName || undefined == attachName) {
                return '';
            }
            if (attachName.length > 0) {
                var attachUrl = '<a class="layui-blue" href="javascript:void(0);" lay-event="file" onclick="openFullModel(\'/attachment/reportshop/attachment/' +
                    d.chinese_attach_nergy + '\');return false;">附件下载</a>';
                return attachUrl;
            }
        }
    </script>
