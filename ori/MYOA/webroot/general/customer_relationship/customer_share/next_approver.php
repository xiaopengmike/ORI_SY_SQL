...
<?php
$param['tableName'] = 'inhe_customer_share_main';
...
if (empty($approverArr) || count($approverArr) == 0) {
    ...
    $sql = "update inhe_customer_share_main set status = 'Y' where form_id = '" . $param['form_id'] . "' ";
    exequery(TD::conn(), $sql);
    $processModel->updateChangeVersion('inhe_customer_share_main',$param['form_id']);
    $shareParam=array(
    ...
    $processModel->addCustomerShare($shareParam);
    ...
    $(function() {
        layui.use(['form', 'layer'], function() {
            ...
            form.on('radio(step)', function(data) {
                ...
                $("#user_id").val('');
                $("#approver_list").val('');
                // 分3种情况：1、指定1人； 2、指定多人 3、选择一人  4发起人 applicant_select 5 主管总监 director_Y 5 主管总监2 leader1 6 manager 部门主管 7 director_ 部门经理
