...
class ActionModel
{
    ...
    public function queryMain($param)
    {
        ...
        $sql = " select k.*, u.user_name createUserName, d.dept_name deptName,c.short_name,tc.zh_name continentName, yc.zh_name countryName from inhe_customer_share_main k " .
    ...
    public function addMain($param)
    {
        ...
        $mainSql = "insert into inhe_customer_share_main (
            organ_id,
            user_id,
            write_time,
            title,
            ...
            $param['form_id'] . "', '" . $param['customer_name'] . "', '" . $userName . "', '" . $param['dept_belong'] . "', '" . $param['remark'] . "', '" . 
            $param['user_id'] . "', '" . $param['customer_id'] . "', '" . $param['status'] . "', '" . $param['type'] . "', '" .$param['user_bu'] . "')";
    ...
    public function updateMainData($param)
    {
        ...
        $tableName = 'inhe_customer_share_main';
    ...
    public function delete()
    {
        ...
        $sql = " delete from inhe_customer_share_main " . $where;
        exequery(TD::conn(), $sql);
        $sql = " delete from inhe_customer_share_user " . $where;
        exequery(TD::conn(), $sql);
