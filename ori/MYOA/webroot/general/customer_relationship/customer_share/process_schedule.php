...
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['流程进度'][$_COOKIE['LANG']]);
    ...
    <div class="weadmin-body" style="width:90%;margin:1% 4%;">
        <form id="mainForm" class="layui-form">
            ...
            <table class="TableBlock" width="100%" style="text-align: center;">
                <thead>
                    <tr>
                        <td class="TableHeader" colspan="6" style="text-align: left;"><?=$LG_CUSTOMER_DATA['流程进度'][$_COOKIE['LANG']]?></td>
                    </tr>
                    <tr>
                        <td class="TableContent"><?=$LG_CUSTOMER_DATA['流程步骤'][$_COOKIE['LANG']]?></td>
                        <td class="TableContent" width="12%"><?=$LG_CUSTOMER_DATA['状态'][$_COOKIE['LANG']]?></td>
                        <td class="TableContent" width="15%"><?=$LG_CUSTOMER_DATA['办理人'][$_COOKIE['LANG']]?></td>
                        <td class="TableContent" width="18%"><?=$LG_CUSTOMER_DATA['办理时间'][$_COOKIE['LANG']]?></td>
                        <td class="TableContent" width="15%"><?=$LG_CUSTOMER_DATA['交办人'][$_COOKIE['LANG']]?></td>
                        <td class="TableContent" width="18%"><?=$LG_CUSTOMER_DATA['交办时间'][$_COOKIE['LANG']]?></td>
                    </tr>
                </thead>
                <tbody id="tab_list">
            ...
            <div style="text-align: center;margin:1%">
                <input name="btn_close" value="<?=$LG_CUSTOMER_DATA['关闭'][$_COOKIE['LANG']];?>" type=button actionType="Close" class="layui-btn layui-btn-oa layui-btn-sm" onclick="closeIframe();return false;" />
            </div>
        </form>
    </div>
</body>
