        ...
        <form id="addForm" class="layui-form">
            ...
            <table class="layui-table" border="0" cellpadding="0" cellspacing="10" lay-size="sm">
                ...
                <tr>
                    ...
                    <td colspan="7">
                        <input type="button" id="apply_attach" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">国内银行电文</td>
                    <td colspan="7">
                        <input type="button" id="bank_attach" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
                    <td class="layui-bg-gray">转开行最终保函</td>
                    <td colspan="7">
                        <input type="button" id="transfer_attach" class="layui-btn layui-bg-gray btn-upload" style="display: inline!important;" value="附件上传" />
                    </td>
                </tr>
                <tr>
