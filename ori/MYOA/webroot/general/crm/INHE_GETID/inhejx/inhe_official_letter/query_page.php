...
$query="select A.*,user.user_name u_name from inhe_crm_official_letter_ihjx A,user WHERE A.USER_ID=user.user_id and A.USER_ID='" . $userId . "' ORDER BY Create_date DESC";
