...
$HTML_PAGE_TITLE = _("备忘录（Memorandum of Understanding）取号");
...
<body class="bodyColorNew">
    <form id="tab" class="layui-form">
        ...
        <table style="margin: 1%">
            <tr>
                <td nowrap align="right">备忘录号码：</td>
                <td>
                    <input type="text" name="pm_id" id="pm_id" class="layui-input" placeholder="请输入备忘录号码">
                </td>
