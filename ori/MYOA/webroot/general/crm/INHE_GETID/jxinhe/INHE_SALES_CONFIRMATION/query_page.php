...
$query="select A.*,user.user_name u_name from inhe_crm_sales_confirmation_jxih A,user WHERE A.USER_ID=user.user_id and A.USER_ID='" . $userId . "' ORDER BY Create_date DESC";
...
<table id="tab1" class="layui-table table-auto">
    <tr class="layui-bg-head layui-bg-gray" id="tabHead">
       <th nowrap style="text-align: center;width: 5%;">序号</th>
        <th nowrap style="text-align: center;width: 10%;">S/C NO.</th>
        <th nowrap style="text-align: center;width: 10%;">对应项目编号</th>
        <th nowrap style="text-align: center;width: 10%;">编号使用人</th>
