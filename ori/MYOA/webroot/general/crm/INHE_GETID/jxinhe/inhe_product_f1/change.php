                ...
                <tr>
                    <td>
                        <table id="tab" width="100%">
                            ...
                            <tr>
                                <td nowrap class="TableContent" style="text-align: center" colspan="2"><b>项目比例关系</b></td>
                            </tr>
                        </table>
                        <table id="tab" width="100%">
                            <tr>
                                <td nowrap class="TableContent" style="text-align: left" colspan="4">变更前：</td>
                            </tr>
                            <tr align="center">
                                <td nowrap class="TableData" width="15%" colspan="2">序号</td>
                                <td nowrap class="TableData" width="35%">人员</td>
                                <td nowrap class="TableData">比例</td>
                            </tr>
                            <?php foreach ($subRes as $key => $val) : ?>
                                <tr align="center">
                                    <td nowrap class="TableData" width="15%" colspan="2">
                                        <?= $val['user_item'] ?>
                                    </td>
                                    <td nowrap class="TableData" width="35%">
                                        <?= $val['user_name'] ?>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td nowrap class="TableContent" style="text-align: left" colspan="4">变更后：</td>
                            </tr>
                            <tr align="center">
