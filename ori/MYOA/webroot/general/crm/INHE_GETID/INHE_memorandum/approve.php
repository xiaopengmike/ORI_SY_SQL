...
<script type="text/javascript">
    $(function() {
        layui.use(['form', 'layer'], function() {
            ...
            var textarea = document.getElementById('reviewed_content');
                        ...
                        <table id="tab3" width="100%">
                            ...
                            <tr>
                                <td nowrap class="TableData" style="text-align: left">
                                    <input type="radio" name="reviewed" value="是" title="同意">
                                    <input type="radio" name="reviewed" value="否" title="不同意">
                                </td>
                            </tr>
                            <tr>
                                <td class="TableData" style="text-align: left">
                                    <textarea name="reviewed_content" placeholder="请输入审核意见" class="layui-textarea"></textarea>
                                </td>
                            </tr>
                            <tr class="layui-bg-body layui-bg-gray" id="tHeader">
                                <td colspan="4" align="center" style="padding: 5px;">
                                    <input name="btn_submit" value="提交" type=button class="layui-btn layui-btn-oa layui-btn-sm" onclick="approveDate(this);return false;" />
