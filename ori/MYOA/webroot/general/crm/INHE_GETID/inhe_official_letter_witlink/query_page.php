...
$query="select A.*,user.user_name u_name from inhe_crm_official_letter_witlink A,user WHERE A.USER_ID=user.user_id and A.USER_ID='" . $userId . "' ORDER BY Create_date DESC";
...
<table id="tab1" class="layui-table table-auto">
    <tr class="layui-bg-head layui-bg-gray" id="tabHead">
       <th nowrap style="text-align: center;width: 5%;">序号</th>
        <th nowrap style="text-align: center;width: 10%;">信函号码</th>
        <th nowrap style="text-align: center;width: 10%;">对应项目编号</th>
        <th nowrap style="text-align: center;width: 10%;">发出名义</th>
