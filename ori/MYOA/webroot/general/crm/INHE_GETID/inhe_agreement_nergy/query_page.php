...
$query="select A.*,user.user_name u_name,inhe_agreement_type.agreement_name from inhe_crm_agreement_nergy A,user,inhe_agreement_type WHERE A.USER_ID=user.user_id and A.agreement_type=inhe_agreement_type.agreement_type and A.USER_ID='" . $userId . "' ORDER BY Create_date DESC";
