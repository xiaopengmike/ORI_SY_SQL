                ...
                <tr>
                    <td>
                        <table id="tab1" width="100%">
                             <tr>
                                <td nowrap class="TableContent" width="15%">合作方英文全称：</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="Partner_name" id="Partner_name" class="layui-input" placeholder="请输入合作方英文全称" style="width: 220px;" />
                                </td>
                            </tr>
                                                      <tr>
                                <td nowrap class="TableContent" width="15%">合作协议类型：</td>
                                <td>
                            <div class="layui-input-inline mandatory">
                                <select id="agreement_type" name="agreement_type" lay-filter="scope_code" lay-search lay-verify="required">
                                <option value=''>请选择</option>
                                <option value='1'>独家代理合作协议</option>
                                <option value='2'>普通代理合作协议</option>
                                <option value='3'>佣金协议</option>
                                ...
                                <option value='5'>其他</option>
                                                      ...
                                                      <tr>
                                <td nowrap class="TableContent" width="15%">授权国家或地区：</td>
                                <td nowrap class="TableData">
                                    <input type="text" name="area_name" id="area_name" class="layui-input" placeholder="请输入授权国家或地区" style="width: 220px;" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td nowrap class="TableData">
                                    <input type="text" name="remark" id="remark" class="layui-input" placeholder="请输入备注" style="width: 220px;" />
                                </td>
                            </tr>
