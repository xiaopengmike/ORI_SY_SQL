...
function GetWeather(HOURS)
{
   ...
   $('weather').innerHTML="<img src='/images/loading.gif' height='20' width='20' align='absMiddle'> "+td_lang.inc.msg_43;//加载中，请稍候……
   var httpReq=getXMLHttpObj();
   httpReq.open("GET","/inc/weather.php?WEATHER_CITY="+WEATHER_CITY+"&VIEW=b&HOURS="+HOURS,true);
