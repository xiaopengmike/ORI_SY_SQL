...
//-- 模块对应ID固定 --
var moduleInfo = {"email":1,"notify":4,"news":147,"vote":119,"workflow":5,"calendar":8,"diary":81,"attendance":7,"bbs":62,"file_folder":15};
var moduleInfoIndex = {"a1":"email","a4":"notify","a147":"news","a119":"vote","a5":"workflow","a8":"calendar","a81":"diary","a7":"attendance","a62":"bbs","a15":"file_folder"};

//-- 可用菜单图标 --
var availappicon = ['address','asset','attendance','bbs','book','calendar','comm','crm','default','diary','document','email','erp','exam_manage','fax','file_folder','hr','info','itask','meeting','mytable','netdisk','news','notify','person_info','picture','project','reportshop','roll_manage','score','sms','system','todo','training','vehicle','vote','wiki','work_plan','workflow'];
...
(function($){
   ...
   function returnFmenu()
   {
      ...
      for(var i=0; i< fmenu.length; i++)
      {
         ...
         html += '<li><a id="m' + menu_id + '" href="javascript:;" hidefocus="hidefocus" title="'+funcarray['m'+menu_id][0]+'"><img src="/images/menu/' + image + '.png" width="20" height="20" align="absMiddle" /> ' + funcarray['m'+menu_id][0] + '</a></li>';
      }
