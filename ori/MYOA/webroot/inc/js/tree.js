...
LoadScript('/inc/js/ispirit.js');
LoadScript('/inc/js/jquery/jquery.min.js' + gz_postfix);
LoadScript('/inc/js/jquery/jquery-ui.custom.min.js' + gz_postfix);
LoadScript('/inc/js/jquery/jquery.cookie.js' + gz_postfix);
LoadScript('/inc/js/jquery/jquery.dynatree.min.js' + gz_postfix);
