...
//-- 模块对应ID固定 --
var moduleInfo = {"email":1,"notify":4,"news":147,"vote":119,"workflow":5,"calendar":8,"diary":81,"attendance":7,"bbs":62,"file_folder":15,"reportshop":550};
var moduleInfoIndex = {"a1":"email","a4":"notify","a147":"news","a119":"vote","a5":"workflow","a8":"calendar","a81":"diary","a7":"attendance","a62":"bbs","a15":"file_folder","a550":"reportshop"};
...
(function($){
   ...
   function returnFmenu()
   {
      ...
      for(var i=0; i< fmenu.length; i++)
      {
         ...
         html += '<li><a id="m' + menu_id + '" href="javascript:;" hidefocus="hidefocus" title="'+funcarray['m'+menu_id][0]+'"><i class="'+image+'"></i> ' + funcarray['m'+menu_id][0] + '</a></li>';
      }
      html += '<li><a id="extWebApp" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.msg_74+'><i class="appbox"></i> '+td_lang.inc.msg_74+'</a></li>';//"互联网应用"
      html += '<li><a id="extFav" href="javascript:;" hidefocus="hidefocus" title='+td_lang.inc.personfav+'><i class="fav"></i> '+td_lang.inc.personfav+'</a></li>';//"个人收藏"
      return html;
   }
