(function($){
	...
	$.sharebox = function(el, settings){
		...
		this.init = function() 
		{
			...
			var toolTopicHtml =		'<a href="javascript:void(0)" hidefocus="hidefocus" class="insert_tools insert_topic" data-type="topicbox" node-type="toolBtn" title="' + settings.lang.insert_topic +'"></a>';

			var toolEmotionHtml =	'<a href="javascript:void(0)" hidefocus="hidefocus" class="insert_tools insert_emotion" data-type="emotionbox" node-type="toolBtn" title="' + settings.lang.insert_emotion +'"></a>';
			...
			if(settings.btn.image){
				var toolPicHtml =	'<a href="javascript:void(0)" hidefocus="hidefocus" class="insert_tools insert_pic" data-type="imagebox" node-type="toolBtn" title="' + settings.lang.insert_pic +'"></a>';
			}else{
				var toolPicHtml = '';
			}
		...
		this.textAreaIt = 
		{
			...
			mini: function(){
				...
				if(dom.val() == "" || dom.val() == settings.lang.tips_default)
				{
					$sharebox.removeClass("wx_hover");
