...
function TANGER_OCX_SetInfo()
{
	...
	try
	{
   	...
   	{
   	   TANGER_OCX_OBJ.AddDocTypePlugin(".pdf","PDF.NtkoDocument","4.0.0.6","./ntkopdfdoc.cab",51,true);
      	TANGER_OCX_OBJ.AddDocTypePlugin(".tif","TIF.NtkoDocument","4.0.0.6","./ntkopdfdoc.cab",52);
      	TANGER_OCX_OBJ.AddDocTypePlugin(".tiff","TIF.NtkoDocument","4.0.0.6","/ntkopdfdoc.cab",52);
      }
