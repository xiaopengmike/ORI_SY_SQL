 ...
 */
// 数据库连接信息
$MYSQL_SERVER = "192.168.4.89:3306";
$MYSQL_USER = "inhe1329";
$MYSQL_PASS = "inhe1329";
$MYSQL_DB = "td_oa_no_data";

// 附件路径配置
$ATTACH_PATH2 = dirname(dirname(__FILE__)) . "/attachment/";
$ATTACH_BACKUP_PATH = $ATTACH_PATH2 . "bak/";
$MYOA_CACHE_PATH = $ATTACH_PATH2 . "cache/";
$MYOA_RECYCLE_PATH = $ATTACH_PATH2 . "recycle/";

// 系统根路径
if (!defined('MYOA_ROOT_PATH')) {
    define('MYOA_ROOT_PATH', dirname(dirname(__FILE__)) . '/');
}

// JS服务器地址（用于静态资源）
if (!defined('MYOA_JS_SERVER')) {
    define('MYOA_JS_SERVER', '');
}
...
// 静态服务器地址（用于图片等资源）
if (!defined('MYOA_STATIC_SERVER')) {
    define('MYOA_STATIC_SERVER', '');
}
