...
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['�ͻ�����'][$_COOKIE['LANG']]);
    ...
    function CheckForm(){
        if($("#order_will").val()=="Y"){
            ...
            if(ifEmpty($("#order_num").val())||!numreg.test($("#order_num").val())){
                var msg='<?=$LG_CUSTOMER_DATA['�вɹ������������������0'][$_COOKIE['LANG']]?>';
                alert(msg);
                return false;
            }
        }
        ...
        <form id="mainForm" class="layui-form" lay-filter="mainForm" method="post" action="action.php?action=Retrieve" accept-charset='gbk' enctype="multipart/form-data" onsubmit="return CheckForm();">
                    ...
                    <table id="tab" width="100%">
                        <tr class="layui-bg-body">
                            <td style="padding: 5px;">
                                <input lay-submit  name="btn_submit" actionType="Save" value="<?=$LG_CUSTOMER_DATA['�ύ'][$_COOKIE['LANG']]?>" type=submit  class="layui-btn layui-btn-oa layui-btn-sm" />
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                ...
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['��ϵ��'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                    ...
                    <tr>
                        <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['��������'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <input type="text" name="flow_date" id="form_date" class="layui-input date" value="<?= date('Y-m-d') ?>" lay-verify="required" />
                        </td>
                    </tr>
                    <tr>
                    <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['��Ǣ��ʽ'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                    ...
                    <tr>
                        <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="need" name="need" placeholder="<?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?>" autocomplete="off" lay-verify="required"></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['�Ƿ�������ɹ���Ʒ'][$_COOKIE['LANG']]?></td>
                        <td class="TableData">
                        <select name="order_will" id="order_will" class="normalSelect" lay-verify="required">
                                    <option value=""><?=$LG_CUSTOMER_DATA['��ѡ��'][$_COOKIE['LANG']]?></option>
                                    <option value='Y' <?php if ($main['order_will'] == 'Y') : ?>selected<?php endif; ?>><?=$LG_CUSTOMER_DATA['��'][$_COOKIE['LANG']]?></option>
                                     <option value='N' <?php if ($main['order_will'] == 'N') : ?>selected<?php endif; ?>><?=$LG_CUSTOMER_DATA['��'][$_COOKIE['LANG']]?></option>
                                    </select>
                        </td>
                    ...
                    <tr>
                        <td class="TableContent"><span class="xing">*</span><?=$LG_CUSTOMER_DATA['��̸����'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="remark" name="remark" placeholder="<?=$LG_CUSTOMER_DATA['��̸����'][$_COOKIE['LANG']]?>" autocomplete="off" lay-verify="required"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
