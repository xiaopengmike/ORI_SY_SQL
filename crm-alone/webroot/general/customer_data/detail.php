...
// ����ҳ�� - ȷ�ϡ��˻ء��ر�
// ����Ǽ�?- ֻ��ʾ��Ϣ
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['�ͻ���Ϣ�ǼǱ�'][$_COOKIE['LANG']]);
...
$main = $data['main'];
$mainid = isset($main['id']) ? $main['id'] : (isset($main[id]) ? $main[id] : 0);
...
$mainType = isset($main['type']) ? $main['type'] : (isset($main[type]) ? $main[type] : 'customer_data');
$flowArr = $process->getFlowStep($mainType, $main['user_bu']);
$curOperate = isset($flowArr[$step]['operate']) ? $flowArr[$step]['operate'] : '';
                        ...
                        <tr class="layui-bg-body layui-bg-gray" id="tHeader">
                            <td align="center" style="padding: 5px;">
                                <?php if ($operate == 'approve' && count($approveInfo) > 0) : ?>
                                    <input lay-submit lay-filter="submit" name="btn_approve" actionType="Approve" value="<?=$LG_CUSTOMER_DATA['�ύ'][$_COOKIE['LANG']]?>" type=button class="layui-btn layui-btn-oa layui-btn-sm" />
                                    <?php if ($operate == 'approve'&&strpos($approveInfo['work_flow'], '����') === false) : ?>
                                    <input lay-submit lay-filter="submit" name="btn_back" actionType="Back" value="<?=$LG_CUSTOMER_DATA['�˻�'][$_COOKIE['LANG']]?>" type=button class="layui-btn layui-btn-oa layui-btn-sm" />
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if ($main['status'] == 'Y' || $main['status'] == 'R' || $main['status'] == 'E'||strpos($approveInfo['work_flow'], '����') !== false) : ?>
                                    <button type="button" class="layui-btn layui-btn-sm layui-btn-oa" onclick="$.printDetail();return false;">��ӡ</button>
                                <?php endif; ?>
                                <input name="btn_close" value="<?=$LG_CUSTOMER_DATA['�ر�'][$_COOKIE['LANG']]?>" type=button class="layui-btn layui-btn-oa layui-btn-sm" onclick="closeIframe();return false;" />
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <tr>
                        <td>
                            <table id="tab1" width="100%" style="text-align: center;">
                                <tr>
                                    <td class="TableContent" width="10%"><?=$LG_CUSTOMER_DATA['�ͻ�����'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" width="15%">
                                        <?= $main['customer_name'] ?>
                                    </td>
                                    <td class=" TableContent" width="10%"><?=$LG_CUSTOMER_DATA['���?][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" width="15%">
                                        <?= $main['short_name'] ?>
                                    </td>
                                    <td class=" TableContent" width="10%"><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                                ...
                                <tr>
                                    <td class=" TableContent"><?=$LG_CUSTOMER_DATA['��ַ'][$_COOKIE['LANG']]?></td>
                                ...
                                <?if($main[user_bu]=="INHENERGY"||$main[user_bu]=="HKNERGY"):?>
                                    ...
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�ͻ���Դ'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" >
                                    ...
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�Ƿ���Ч'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" >
                                    ...
                                    <!-- <td class="TableContent"><?=$LG_CUSTOMER_DATA['�Ǽ�'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" >
                                    ...
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�Ǽ�ͼ��'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" colspan="3">
                                        <div id="star_icon">
                                ...
                                <?if($main[user_bu]=="INHENERGY"||$main[user_bu]=="HKNERGY"):?>
                                <tr>
                                    <td class=" TableContent"><?=$LG_CUSTOMER_DATA['�ͻ���ע'][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" colspan="7">
                                ...
                                <?endif;?>
                                <tr>
                                    <td class="TableHeader" colspan="8"><?=$LG_CUSTOMER_DATA['��ϵ��'][$_COOKIE['LANG']]?></td>
                                </tr>
                                <tr>
                                <td class="TableContent"><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�绰1'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�绰2'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['ְλ'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent" colspan="2"><?=$LG_CUSTOMER_DATA['��ַ'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['��ע'][$_COOKIE['LANG']]?></td>
                                </tr>
                                ...
                                <?php endforeach; ?>
                                <tr>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�ͻ�������˾'][$_COOKIE['LANG']]?><br />��<?=$LG_CUSTOMER_DATA['��ͬ��Է�?][$_COOKIE['LANG']]?>��</td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['���?][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent" colspan="3"><?=$LG_CUSTOMER_DATA['��ַ'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['��ϵ������'][$_COOKIE['LANG']]?></td>
                                    <td class="TableContent"><?=$LG_CUSTOMER_DATA['�绰'][$_COOKIE['LANG']]?></td>
                                </tr>
                            ...
                            <table id="tab3" width="100%">
                                <tr>
                                    <td class="TableContent"  style="text-align: left;width: 25%"><?=$LG_CUSTOMER_DATA['���˵��?][$_COOKIE['LANG']]?></td>
                                    <td class="TableData" >
                                    
                                        <textarea readonly class="layui-textarea" id="change_explain" name="change_explain" placeholder="���˵��? ><?=$main[change_explain]?></textarea>
                                    </td>
                                </tr>
                            </table>
                            <?endif;?>
                            <table id="tab3" width="100%">
                                <tr>
                                    <td class="TableContent" style="text-align: left;width: 25%"><?=$LG_CUSTOMER_DATA['�Ǽǵ���'][$_COOKIE['LANG']]?>�� <?= $main['form_id'] ?></td>
                                    <td class="TableContent" style="text-align: left;width: 25%"><?=$LG_CUSTOMER_DATA['��������'][$_COOKIE['LANG']]?>�� <?= $main['deptName'] ?></td>
                                    <td class="TableContent" style="text-align: left;width: 25%"><?=$LG_CUSTOMER_DATA['�Ǽ���'][$_COOKIE['LANG']]?>�� <?= $main['createUserName'] ?></td>
                                    <td class="TableContent" style="text-align: left;"><?=$LG_CUSTOMER_DATA['�Ǽ�ʱ��'][$_COOKIE['LANG']]?>�� <?= $main['write_time'] ?></td>
                                </tr>
                                <?php if (!empty($share)) : ?>
                                    <tr align="left">
                                        <td colspan="4" class="TableContent" style="text-align: left;"><?=$LG_CUSTOMER_DATA['����ҵ����Ա'][$_COOKIE['LANG']]?>�� <?= $share ?></td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                            <?php
