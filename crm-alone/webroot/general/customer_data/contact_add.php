...
$HTML_PAGE_TITLE = _($LG_CUSTOMER_DATA['��ϵ��'][$_COOKIE['LANG']]);
    ...
    <div style="width: 100%;height:auto;margin:auto;">
        <form id="mainForm" class="layui-form" lay-filter="mainForm" method="post" action="action.php?action=Retrieve" accept-charset='gbk' enctype="multipart/form-data">
            ...
            <div class="weadmin-body" style="width:80%;margin:1% 9%;">
                <input type="hidden" name="dataType" id="dataType" value="addCustomerContact" />
                ...
                <input type="hidden" name="user_bu" id="user_bu" value="INHENERGY" />
                <table class="TableBlock" width="100%" align="center">
                    ...
                    <tr>
                        ...
                        <td class="TableData" colspan="3">
                            <input type="text" name="phone_one"  class="layui-input" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TableContent"><?=$LG_CUSTOMER_DATA['�绰2'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <input type="text" name="phone_two"  class="layui-input" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TableContent"><?=$LG_CUSTOMER_DATA['����'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <input type="text" name="email"  class="layui-input" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TableContent"><?=$LG_CUSTOMER_DATA['ְλ'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <input type="text" name="position"  class="layui-input" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td class="TableContent"><?=$LG_CUSTOMER_DATA['��ַ'][$_COOKIE['LANG']]?></td>
                        <td class="TableData" colspan="3">
                            <input type="text" name="address"  class="layui-input" value="" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="TableData" colspan="3">
                            <textarea class="layui-textarea" id="remark" name="remark" placeholder="<?=$LG_CUSTOMER_DATA['��ע'][$_COOKIE['LANG']]?>" autocomplete="off"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
