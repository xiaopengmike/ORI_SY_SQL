...
$HTML_PAGE_TITLE = $LG_CUSTOMER_DATA['提交'][$_COOKIE['LANG']]." ".$LG_CUSTOMER_DATA['成功'][$_COOKIE['LANG']];
...
<body>
    <form id="mainForm" class="layui-form" style="text-align: center;">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
            <legend><?=$LG_CUSTOMER_DATA['提交'][$_COOKIE['LANG']]." ".$LG_CUSTOMER_DATA['成功'][$_COOKIE['LANG']]?></legend>
        </fieldset>
